      ...
      <h1 className="text-2xl text-primary  transition-all">
        ...
        <div className="group">
          <a target="_blank" href="/Xurshed_Alimmamadov_CV.pdf">
            <div className="flex my-4 p-4 transition-all supports-hover:group-hover:opacity-70 supports-hover:hover:!opacity-100  supports-hover:hover:bg-[rgb(225,225,225,0.1)]">
              ...
              <div className="flex-1">
                ...
                <article className="flex-2 text-sm text-secondary supports-hover:group-hover:text-primary transition-all">
